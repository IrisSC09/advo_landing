    ...
    >
      <div className="container mx-auto px-4 md:px-6 text-center text-white">
        ...
        <p className="text-base md:text-xl max-w-5xl mx-auto mb-6 font-light leading-relaxed">
          Advoline's mission is to democratize civic education and advocacy for
          youth activists. Through our platform, we aim to create tangible
          political change.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 max-w-7xl mx-auto">
          ...
          <div className="bg-black/80 p-8 rounded-2xl border border-gray-700 hover-lift">
            ...
            <p className="text-gray-300 leading-relaxed">
              Fostering understanding through creative expression and fact-based
              discussions that bridge divides.
            </p>
          </div>
