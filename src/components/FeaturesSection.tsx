    ...
    >
      <div className="container mx-auto px-4 md:px-6 text-center text-white">
        ...
        <p className="text-base md:text-xl max-w-5xl mx-auto mb-10 md:mb-16 font-light leading-relaxed">
          Everything you need to understand, engage with, and influence the
          political process.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 max-w-7xl mx-auto">
          ...
          <div className="feature-card bg-gray-800/90 p-8 rounded-2xl border border-gray-600">
            ...
            <p className="text-gray-300 leading-relaxed text-left mb-4">
              Connect directly with representatives and track real policy
              changes driven by community action.
            </p>
          </div>
        </div>
      </div>
